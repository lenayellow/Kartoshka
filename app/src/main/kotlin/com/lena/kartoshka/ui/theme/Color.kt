...
val Secondary = Color(0xFF3D6B56)
val OnSecondary = Color(0xFFFFFFFF)
val SecondaryContainer = Color(0xFFD6EDE2)
val OnSecondaryContainer = Color(0xFF0F2B1F)

val Tertiary = Color(0xFF7A6545)
val OnTertiary = Color(0xFFFFFFFF)
val TertiaryContainer = Color(0xFFF0E0C4)
val OnTertiaryContainer = Color(0xFF2C2010)
...
val SurfaceDim = Color(0xFFDDD8CF)
val SurfaceBright = Color(0xFFFAF8F3)
val SurfaceContainerLowest = Color(0xFFFFFFFF)
val SurfaceContainerLow = Color(0xFFF0EBE2)
val SurfaceContainer = Color(0xFFEAE5DC)
val SurfaceContainerHigh = Color(0xFFE4DED5)
val SurfaceContainerHighest = Color(0xFFDED8CE)
...
val InversePrimary = Color(0xFF9DD4B5)
